...
class Worker
{
    private ConcurrencyLimitDeferred $deferred;

    public function __construct()
    {
        $this->deferred = new ConcurrencyLimitDeferred(new ReusableDeferred());
    }
    ...
    public function calculate($result)
    {
        ...
        $backgroundTask = static function (ConcurrencyLimitDeferred $deferred, $result) {
